...
the Council for Countering Online Disinformation for helpful comments.
Selected algebraic results have companion Lean~4 formalizations
against mathlib \citep{moura2021lean,mathlib2020lean};
Appendix~\ref{app:proofs} specifies their scope. They do not verify empirical identification
