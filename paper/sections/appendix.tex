...
The source, figures and tables are versioned with the empirical code.
...
The pipeline preserves observed outcomes, replaces conditioning
...
retrieval information available for this study, and the limitations of the
merged panel. Raw-vintage details cannot be reconstructed
from an undocumented download date, so the paper makes no real-time claim.

Numerical tests cover calendar alignment, observed outcomes, training-only
transformations, bootstrap contrasts and covariance propagation. Source
changes and remaining research limitations are documented in the project
notes.
