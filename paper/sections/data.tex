...
original DSP components required for this procedure are included in the
...
outcomes. These outcome series are never interpolated or filled in the revised
...
reported separately. The original repository's two-sided interpolated
columns remain in the frozen input for provenance but are replaced in memory
before the revised pipeline runs. Calendar-year matching prevents a gap from
being mistaken for a one-year lag.
