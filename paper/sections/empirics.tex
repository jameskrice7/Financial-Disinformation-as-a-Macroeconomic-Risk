...
distinct, roughly threefold lower-tail association.
\begin{figure}[!htbp]\centering
...
The regional-pressure instrument interacted with internet penetration does not
establish identification. Internet exposure may affect
...
Those weak-IV estimates are omitted from the identification evidence. The
optional implementation is restricted to post-2004 observations and its
excluded-instrument diagnostic is corrected; it remains an exploratory
robustness check rather than causal corroboration.
