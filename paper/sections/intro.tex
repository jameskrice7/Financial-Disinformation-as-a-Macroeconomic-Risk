...
messages that are false. The revised analysis retains that distinction
...
The revised three-year cumulative-growth coefficient is
...
from the median or upper tail. This weakens the original interpretation of
a disproportionately large downside association.
...
presents revised estimation and validation. Sections~\ref{sec:risk} and
